...
class CreateChatTables extends Migration
{
    ...
    public function up()
    {
        ...
        Schema::create(ConfigurationManager::PARTICIPATION_TABLE, function (Blueprint $table) {
            ...
            $table->foreign('conversation_id')->references('id')->on(ConfigurationManager::CONVERSATIONS_TABLE)->onDelete('cascade');
        });
        ...
        Schema::create(ConfigurationManager::MESSAGES_TABLE, function (Blueprint $table) {
            ...
            $table->foreign('participation_id')->references('id')->on(ConfigurationManager::PARTICIPATION_TABLE)->onDelete('set null');
        ...
        Schema::create(ConfigurationManager::MESSAGE_NOTIFICATIONS_TABLE, function (Blueprint $table) {
            ...
            $table->foreign('message_id')->references('id')->on(ConfigurationManager::MESSAGES_TABLE)->onDelete('cascade');

            $table->foreign('conversation_id')->references('id')->on(ConfigurationManager::CONVERSATIONS_TABLE)->onDelete('cascade');

            $table->foreign('participation_id')->references('id')->on(ConfigurationManager::PARTICIPATION_TABLE)->onDelete('cascade');
        });
    }
