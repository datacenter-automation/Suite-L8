...
$d = new DNS2D();
$d->setStorPath(public_path('/img/barcodes/'));

echo $d->getBarcodePNGPath("http://theautomateddatacenter.com", 'QRCODE', 2, 2);
?>
...
<div class="overflow-hidden bg-white">
    ...
    <div class="relative z-10 pb-8 bg-white sm:pb-16 md:pb-20 lg:max-w-2xl lg:w-full lg:pb-28 xl:pb-32">
      ...
      <div class="relative px-4 pt-6 sm:px-6 lg:px-8">
        <nav class="relative flex items-center justify-between sm:h-10 lg:justify-start" aria-label="Global">
          ...
          <div class="hidden md:block md:ml-5 md:pr-8 md:space-x-2">
            <a href="#" class="font-medium text-gray-500 hover:text-gray-900">Products</a>
            <a href="#" class="font-medium text-gray-500 hover:text-gray-900">Solutions</a>
            ...
            <a href="#" class="font-medium text-gray-500 hover:text-gray-900">Docs</a>
            ...
            @auth
              <a href="{{ route('dashboard') }}" class="font-medium text-indigo-600 hover:text-indigo-500">Panel</a>
            @endauth
  ...
  <div class="lg:absolute lg:inset-y-0 lg:right-0 lg:w-1/2">
    <img class="object-cover w-full h-56 sm:h-72 md:h-96 lg:w-full lg:h-full"
         src="https://images.unsplash.com/photo-1551434678-e076c223a692?ixlib=rb-1.2.1&ixqx=hFcIz7dS9K&ixid=eyJhcHBfaWQiOjEyMDd9&auto=format&fit=crop&w=2850&q=80"
         alt="">
  </div>
</div>
</body>
