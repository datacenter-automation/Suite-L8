...
@section('content')
  ...
  <div class="panel panel-default">
    ...
    <div class="panel-heading clearfix">
      ...
      <div class="pull-left">
        <h4 class="mt-5 mb-5">{{ !empty($softwareCategory->name) ? $softwareCategory->name : 'Software Category' }}</h4>
      </div>
    ...
    <div class="panel-body">
      ...
      <form method="POST" action="{{ route('software_categories.software_category.update', $softwareCategory->id) }}"
            id="edit_software_category_form" name="edit_software_category_form" accept-charset="UTF-8"
            class="form-horizontal">
        {{ csrf_field() }}
        <input name="_method" type="hidden" value="PUT">
        @include ('software_categories.form', [
