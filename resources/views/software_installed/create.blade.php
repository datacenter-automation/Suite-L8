...
@section('content')
  ...
  <div class="panel panel-default">
    ...
    <div class="panel-body">
      ...
      <form method="POST" action="{{ route('software_installed.software_installed.store') }}" accept-charset="UTF-8"
            id="create_software_installed_form" name="create_software_installed_form" class="form-horizontal">
        {{ csrf_field() }}
