      ...
      <div class="panel-body panel-body-with-table">
        <div class="table-responsive">
          ...
          <table class="table table-striped ">
            ...
            <tbody>
            @foreach($machineNotes as $machineNote)
              <tr>
                <td>{{ optional($machineNote->Machine)->name }}</td>
                ...
                <td>
                  ...
                  <form method="POST" action="{!! route('machine_notes.machine_note.destroy', $machineNote->id) !!}"
                    ...
                    <div class="btn-group btn-group-xs pull-right" role="group">
                      <a href="{{ route('machine_notes.machine_note.show', $machineNote->id ) }}" class="btn btn-info"
                         title="Show Machine Note">
                        <span class="glyphicon glyphicon-open" aria-hidden="true"></span>
                      </a>
                      <a href="{{ route('machine_notes.machine_note.edit', $machineNote->id ) }}"
                         class="btn btn-primary" title="Edit Machine Note">
