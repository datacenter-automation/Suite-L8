  ...
  <div class="col-md-10">
    <select class="form-control" id="ticket_id" name="ticket_id" required="true">
      <option value="" style="display: none;"
              {{ old('ticket_id', optional($ticketLog)->ticket_id ?: '') == '' ? 'selected' : '' }} disabled selected>
        Select ticket
      </option>
...
<div class="form-group {{ $errors->has('user_id') ? 'has-error' : '' }}">
  ...
  <div class="col-md-10">
    <select class="form-control" id="user_id" name="user_id" required="true">
      <option value="" style="display: none;"
              {{ old('user_id', optional($ticketLog)->user_id ?: '') == '' ? 'selected' : '' }} disabled selected>Select
        user
      </option>
...
<div class="form-group {{ $errors->has('content') ? 'has-error' : '' }}">
  ...
  <div class="col-md-10">
    <input class="form-control" name="content" type="text" id="content"
           value="{{ old('content', optional($ticketLog)->content) }}" minlength="1" maxlength="4294967295"
