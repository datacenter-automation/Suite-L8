...
@section('content')
  ...
  <div class="panel panel-default">
    ...
    <div class="panel-body">
      ...
      <form method="POST" action="{{ route('messages.message.update', $message->id) }}" id="edit_message_form"
            name="edit_message_form" accept-charset="UTF-8" class="form-horizontal">
        {{ csrf_field() }}
