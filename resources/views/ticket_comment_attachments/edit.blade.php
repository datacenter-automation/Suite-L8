...
@section('content')
  ...
  <div class="panel panel-default">
    ...
    <div class="panel-heading clearfix">
      ...
      <div class="pull-left">
        <h4 class="mt-5 mb-5">{{ !empty($title) ? $title : 'Ticket Comment Attachment' }}</h4>
      </div>
    ...
    <div class="panel-body">
      ...
      <form method="POST"
            action="{{ route('ticket_comment_attachments.ticket_comment_attachment.update', $ticketCommentAttachment->id) }}"
            id="edit_ticket_comment_attachment_form" name="edit_ticket_comment_attachment_form" accept-charset="UTF-8"
