        ...
        <nav class="relative flex items-center justify-between px-6 pt-8 mx-auto max-w-7xl xl:px-8" aria-label="Global">
          <div class="flex items-center justify-between w-full lg:w-auto">
            <a href="#">
              ...
              <img class="w-auto h-8 sm:h-10" src="https://tailwindui.com/img/logos/workflow-mark.svg?color=purple&shade=600" alt="">
            </a>
          ...
          <div class="hidden lg:flex lg:items-center lg:space-x-6">
            <a href="#" class="px-6 py-2 text-base font-medium bg-white border border-transparent rounded-md shadow-md text-grape-600 hover:bg-gray-50">
              Contact
            </a>
          </div>
        </nav>
      ...
      <div class="absolute inset-x-0 top-0 p-2 transition origin-top transform lg:hidden">
        <div class="overflow-hidden bg-white rounded-lg shadow-lg ring-1 ring-black ring-opacity-5">
          <div class="flex items-center justify-between px-5 pt-4">
            <div>
              <img class="w-auto h-8" src="https://tailwindui.com/img/logos/workflow-mark.svg?color=purple&shade=600" alt="">
            </div>
            <div class="-mr-2">
    ...
    <main>
      ...
      <div class="py-24 bg-gray-50 sm:py-32">
        <div class="max-w-md pl-4 pr-8 mx-auto sm:max-w-lg sm:px-6 lg:max-w-7xl lg:px-8">
          <h1 class="text-4xl font-extrabold leading-10 tracking-tight text-center text-gray-900 sm:text-5xl sm:leading-none lg:text-6xl">Get in touch</h1>
          <p class="max-w-3xl mx-auto mt-6 text-xl leading-normal text-center text-gray-500">Convallis feugiat et aliquet pellentesque dictum nisi, velit. Egestas fermentum adipiscing risus quam ac consectetur mattis turpis tristique.</p>
        </div>
      </div>
      ...
      <div class="relative bg-white">
        <div class="lg:absolute lg:inset-0">
          <div class="lg:absolute lg:inset-y-0 lg:right-0 lg:w-1/2">
            <img class="object-cover w-full h-56 lg:absolute lg:h-full" src="https://images.unsplash.com/photo-1556761175-4b46a572b786?ixlib=rb-1.2.1&ixqx=hFcIz7dS9K&ixid=eyJhcHBfaWQiOjEyMDd9&auto=format&fit=crop&w=1567&q=80" alt="">
          </div>
        </div>
            ...
            <div class="max-w-md mx-auto sm:max-w-lg lg:mx-0">
              ...
              <form action="#" method="POST" class="grid grid-cols-1 mt-9 gap-y-6 sm:grid-cols-2 sm:gap-x-8">
                <div>
                  ...
                  <div class="mt-1">
                    <input type="text" name="first_name" id="first_name" autocomplete="given-name" class="block w-full border-gray-300 rounded-md shadow-sm sm:text-sm focus:ring-grape-500 focus:border-grape-500">
                  </div>
                </div>
                <div>
                  <label for="last_name" class="block text-sm font-medium text-gray-700">Last name</label>
                  <div class="mt-1">
                    <input type="text" name="last_name" id="last_name" autocomplete="family-name" class="block w-full border-gray-300 rounded-md shadow-sm sm:text-sm focus:ring-grape-500 focus:border-grape-500">
                  </div>
                </div>
                ...
                <div class="sm:col-span-2">
                  ...
                  <div class="mt-1">
                    <input type="text" name="company" id="company" autocomplete="organization" class="block w-full border-gray-300 rounded-md shadow-sm sm:text-sm focus:ring-grape-500 focus:border-grape-500">
                  </div>
                </div>
                <div class="sm:col-span-2">
                  ...
                  <div class="mt-1">
                    <input type="text" name="phone" id="phone" autocomplete="tel" aria-describedby="phone_description" class="block w-full border-gray-300 rounded-md shadow-sm sm:text-sm focus:ring-grape-500 focus:border-grape-500">
                  </div>
                </div>
                <div class="sm:col-span-2">
                  <div class="flex justify-between">
                  ...
                  <div class="mt-1">
                    <textarea id="how_can_we_help" name="how_can_we_help" aria-describedby="how_can_we_help_description" rows="4" class="block w-full border-gray-300 rounded-md shadow-sm sm:text-sm focus:ring-grape-500 focus:border-grape-500"></textarea>
                  </div>
                </div>
                <fieldset class="sm:col-span-2">
                  ...
                  <div class="grid grid-cols-1 mt-4 gap-y-4">
                    <div class="flex items-center">
                      <input id="budget_under_25k" name="budget" value="under_25k" type="radio" class="w-4 h-4 border-gray-300 focus:ring-grape-500 text-grape-600">
                      <label for="budget_under_25k" class="ml-3">
                        <span class="block text-sm text-gray-700">Less than $25K</span>
                      </label>
                    </div>
                    <div class="flex items-center">
                      <input id="budget_25k-50k" name="budget" value="25k-50k" type="radio" class="w-4 h-4 border-gray-300 focus:ring-grape-500 text-grape-600">
                      <label for="budget_25k-50k" class="ml-3">
                        <span class="block text-sm text-gray-700">$25K – $50K</span>
                      </label>
                    </div>
                    <div class="flex items-center">
                      <input id="budget_50k-100k" name="budget" value="50k-100k" type="radio" class="w-4 h-4 border-gray-300 focus:ring-grape-500 text-grape-600">
                      <label for="budget_50k-100k" class="ml-3">
                        <span class="block text-sm text-gray-700">$50K – $100K</span>
                      </label>
                    </div>
                    <div class="flex items-center">
                      <input id="budget_over_100k" name="budget" value="over_100k" type="radio" class="w-4 h-4 border-gray-300 focus:ring-grape-500 text-grape-600">
                ...
                <div class="sm:col-span-2">
                  ...
                  <div class="mt-1">
                    <input type="text" name="how_did_you_hear_about_us" id="how_did_you_hear_about_us" class="block w-full border-gray-300 rounded-md shadow-sm focus:ring-grape-500 focus:border-grape-500 sm:text-sm">
                  </div>
                </div>
