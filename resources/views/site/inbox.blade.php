...
<div class="flex flex-col h-screen overflow-hidden bg-gray-100">
    ...
    <header class="relative flex items-center flex-shrink-0 h-16 bg-white">
      ...
      <div class="absolute inset-y-0 left-0 lg:static lg:flex-shrink-0">
        <a href="#" class="flex items-center justify-center w-16 h-16 bg-cyan-400 focus:outline-none focus:ring-2 focus:ring-inset focus:ring-blue-600 lg:w-20">
      ...
      <div class="mx-auto lg:hidden">
        <div class="relative">
          ...
          <select id="inbox-select" class="pl-3 pr-8 text-base font-medium text-gray-900 border-0 rounded-md bg-none focus:ring-2 focus:ring-blue-600">
      ...
      <div class="absolute inset-y-0 right-0 flex items-center pr-4 sm:pr-6 lg:hidden">
        <!-- Mobile menu button -->
        <button type="button" class="inline-flex items-center justify-center p-2 -mr-2 text-gray-400 rounded-md hover:text-gray-500 hover:bg-gray-100 focus:outline-none focus:ring-2 focus:ring-inset focus:ring-blue-600">
      ...
      <div class="hidden lg:min-w-0 lg:flex-1 lg:flex lg:items-center lg:justify-between">
        <div class="flex-1 min-w-0">
          <div class="relative max-w-2xl text-gray-400 focus-within:text-gray-500">
            ...
            <input id="search" type="search" placeholder="Search all inboxes" class="block w-full pl-12 placeholder-gray-500 border-transparent focus:border-transparent sm:text-sm focus:ring-0">
        ...
        <div class="flex items-center flex-shrink-0 pr-4 ml-10 space-x-10">
          <nav aria-label="Global" class="flex space-x-10">
            <div class="relative text-left">
              <button type="button" class="flex items-center text-sm font-medium text-gray-900 rounded-md focus:outline-none focus:ring-2 focus:ring-offset-2 focus:ring-blue-600" id="menu-1" aria-expanded="false" aria-haspopup="true">
                <span>Inboxes</span>
                <!-- Heroicon name: solid/chevron-down -->
              ...
              -->
              <div class="absolute right-0 z-30 w-40 mt-2 origin-top-right bg-white rounded-md shadow-lg ring-1 ring-black ring-opacity-5 focus:outline-none" role="menu" aria-orientation="vertical" aria-labelledby="menu-1">
          ...
          <div class="flex items-center space-x-8">
            ...
            <div class="relative inline-block text-left">
              <button type="button" class="flex text-sm bg-white rounded-full focus:outline-none focus:ring-2 focus:ring-offset-2 focus:ring-blue-600" id="menu-2" aria-expanded="false" aria-haspopup="true">
                <span class="sr-only">Open user menu</span>
                <img class="w-8 h-8 rounded-full" src="https://images.unsplash.com/photo-1517365830460-955ce3ccd263?ixlib=rb-1.2.1&ixqx=hFcIz7dS9K&ixid=eyJhcHBfaWQiOjEyMDd9&auto=format&fit=facearea&facepad=2&w=256&h=256&q=80" alt="">
              </button>
              ...
              <!--
                ...
                Leaving: "transition ease-in duration-75"
                  ...
                  To: "transform opacity-0 scale-95"
              -->
              <div class="absolute right-0 z-30 w-56 mt-2 origin-top-right bg-white rounded-md shadow-lg ring-1 ring-black ring-opacity-5 focus:outline-none" role="menu" aria-orientation="vertical" aria-labelledby="menu-2">
                <div class="py-1" role="none">
                  <a href="#" class="block px-4 py-2 text-sm text-gray-700 hover:bg-gray-100" role="menuitem">
                    Your Profile
                  </a>
      ...
      <div class="fixed inset-0 z-40 lg:hidden" role="dialog" aria-modal="true">
        ...
        -->
        <nav class="fixed inset-0 z-40 w-full h-full bg-white sm:inset-y-0 sm:left-auto sm:right-0 sm:max-w-sm sm:w-full sm:shadow-lg" aria-label="Global">
          <div class="flex items-center justify-between h-16 px-4 sm:px-6">
            <a href="#">
              <img class="block w-auto h-8" src="https://tailwindui.com/img/logos/workflow-mark.svg?color=cyan&shade=400" alt="Workflow">
            </a>
            <button type="button" class="inline-flex items-center justify-center p-2 -mr-2 text-gray-400 rounded-md hover:text-gray-500 hover:bg-gray-100 focus:outline-none focus:ring-2 focus:ring-inset focus:ring-blue-600">
          ...
          <div class="px-4 mx-auto mt-2 max-w-8xl sm:px-6">
            <div class="relative text-gray-400 focus-within:text-gray-500">
              <label for="search" class="sr-only">Search all inboxes</label>
              <input id="search" type="search" placeholder="Search all inboxes" class="block w-full pl-10 placeholder-gray-500 border-gray-300 rounded-md focus:border-blue-600 focus:ring-blue-600">
          ...
          <div class="px-2 py-3 mx-auto max-w-8xl sm:px-4">
            <a href="#" class="block px-3 py-2 text-base font-medium text-gray-900 rounded-md hover:bg-gray-100">Inboxes</a>
  
            <a href="#" class="block py-2 pl-5 pr-3 text-base font-medium text-gray-500 rounded-md hover:bg-gray-100">Technical Support</a>
            ...
            <a href="#" class="block px-3 py-2 text-base font-medium text-gray-900 rounded-md hover:bg-gray-100">Reporting</a>
          ...
          <div class="pt-4 pb-3 border-t border-gray-200">
            <div class="flex items-center px-4 mx-auto max-w-8xl sm:px-6">
              <div class="flex-shrink-0">
                <img class="w-10 h-10 rounded-full" src="https://images.unsplash.com/photo-1517365830460-955ce3ccd263?ixlib=rb-1.2.1&ixqx=hFcIz7dS9K&ixid=eyJhcHBfaWQiOjEyMDd9&auto=format&fit=facearea&facepad=2&w=256&h=256&q=80" alt="">
              </div>
            ...
            <div class="px-2 mx-auto mt-3 space-y-1 max-w-8xl sm:px-4">
              <a href="#" class="block px-3 py-2 text-base font-medium text-gray-900 rounded-md hover:bg-gray-50">Your Profile</a>
  
              <a href="#" class="block px-3 py-2 text-base font-medium text-gray-900 rounded-md hover:bg-gray-50">Sign out</a>
            </div>
          </div>
        </nav>
      </div>
    ...
    <div class="flex flex-1 min-h-0 overflow-hidden">
      ...
      <nav aria-label="Sidebar" class="hidden lg:block lg:flex-shrink-0 lg:bg-gray-800 lg:overflow-y-auto">
        <div class="relative flex flex-col w-20 p-3 space-y-3">
          <a href="#" class="inline-flex items-center justify-center flex-shrink-0 text-white bg-gray-900 rounded-lg h-14 w-14">
          ...
          <a href="#" class="inline-flex items-center justify-center flex-shrink-0 text-gray-400 rounded-lg hover:bg-gray-700 h-14 w-14">
                ...
                <div class="flex justify-between py-3">
                  ...
                  <div>
                    <span class="relative z-0 inline-flex rounded-md shadow-sm sm:shadow-none sm:space-x-3">
                      <span class="inline-flex sm:shadow-sm">
                        <button type="button" class="relative inline-flex items-center px-4 py-2 text-sm font-medium text-gray-900 bg-white border border-gray-300 rounded-l-md hover:bg-gray-50 focus:z-10 focus:outline-none focus:ring-1 focus:ring-blue-600 focus:border-blue-600">
                        ...
                        <button type="button" class="relative items-center hidden px-4 py-2 -ml-px text-sm font-medium text-gray-900 bg-white border border-gray-300 sm:inline-flex hover:bg-gray-50 focus:z-10 focus:outline-none focus:ring-1 focus:ring-blue-600 focus:border-blue-600">
                        ...
                        <button type="button" class="relative items-center hidden px-4 py-2 -ml-px text-sm font-medium text-gray-900 bg-white border border-gray-300 sm:inline-flex rounded-r-md hover:bg-gray-50 focus:z-10 focus:outline-none focus:ring-1 focus:ring-blue-600 focus:border-blue-600">
                      ...
                      <span class="hidden space-x-3 lg:flex">
                        <button type="button" class="relative items-center hidden px-4 py-2 -ml-px text-sm font-medium text-gray-900 bg-white border border-gray-300 rounded-md sm:inline-flex hover:bg-gray-50 focus:z-10 focus:outline-none focus:ring-1 focus:ring-blue-600 focus:border-blue-600">
                      ...
                      <span class="relative block -ml-px sm:shadow-sm lg:hidden">
                        <div>
                          <button type="button" class="relative inline-flex items-center px-2 py-2 text-sm font-medium text-gray-900 bg-white border border-gray-300 rounded-r-md hover:bg-gray-50 focus:z-10 focus:outline-none focus:ring-1 focus:ring-blue-600 focus:border-blue-600 sm:rounded-md sm:px-3" id="menu-3" aria-expanded="false" aria-haspopup="true">
                            <span class="sr-only sm:hidden">More</span>
                            <span class="hidden sm:inline">More</span>
                            <!-- Heroicon name: solid/chevron-down -->
                            <svg class="w-5 h-5 text-gray-400 sm:ml-2 sm:-mr-1" xmlns="http://www.w3.org/2000/svg" viewBox="0 0 20 20" fill="currentColor" aria-hidden="true">
                              <path fill-rule="evenodd" d="M5.293 7.293a1 1 0 011.414 0L10 10.586l3.293-3.293a1 1 0 111.414 1.414l-4 4a1 1 0 01-1.414 0l-4-4a1 1 0 010-1.414z" clip-rule="evenodd" />
                            </svg>
                          </button>
                        </div>
                        ...
                        <!--
                          ...
                          Leaving: "transition ease-in duration-75"
                            ...
                            To: "transform opacity-0 scale-95"
                        -->
                        <div class="absolute right-0 mt-2 origin-top-right bg-white rounded-md shadow-lg w-36 ring-1 ring-black ring-opacity-5 focus:outline-none" role="menu" aria-orientation="vertical" aria-labelledby="menu-3">
                          <div class="py-1" role="none">
                            <a href="#" class="block px-4 py-2 text-sm text-gray-700 sm:hidden hover:bg-gray-100 hover:text-gray-900" role="menuitem">
                              Note
                            </a>
                            <a href="#" class="block px-4 py-2 text-sm text-gray-700 sm:hidden hover:bg-gray-100 hover:text-gray-900" role="menuitem">
                              Assign
                  ...
                  <nav aria-label="Pagination">
                    <span class="relative z-0 inline-flex rounded-md shadow-sm">
                      <a href="#" class="relative inline-flex items-center px-4 py-2 text-sm font-medium text-gray-500 bg-white border border-gray-300 rounded-l-md hover:bg-gray-50 focus:z-10 focus:outline-none focus:ring-1 focus:ring-blue-600 focus:border-blue-600">
                      ...
                      <a href="#" class="relative inline-flex items-center px-4 py-2 -ml-px text-sm font-medium text-gray-500 bg-white border border-gray-300 rounded-r-md hover:bg-gray-50 focus:z-10 focus:outline-none focus:ring-1 focus:ring-blue-600 focus:border-blue-600">
              ...
              <div class="px-4 sm:flex sm:justify-between sm:items-baseline sm:px-6 lg:px-8">
                ...
                <div class="flex items-center justify-between mt-4 sm:mt-0 sm:ml-6 sm:flex-shrink-0 sm:justify-start">
                  ...
                  <div class="relative inline-block ml-3 text-left">
                    <div>
                      <button type="button" class="flex items-center p-2 -my-2 text-gray-400 bg-white rounded-full hover:text-gray-600 focus:outline-none focus:ring-2 focus:ring-blue-600" id="menu-4" aria-expanded="false" aria-haspopup="true">
                    ...
                    <!--
                      ...
                      Leaving: "transition ease-in duration-75"
                        ...
                        To: "transform opacity-0 scale-95"
                    -->
                    <div class="absolute right-0 w-56 mt-2 origin-top-right bg-white rounded-md shadow-lg ring-1 ring-black ring-opacity-5 focus:outline-none" role="menu" aria-orientation="vertical" aria-labelledby="menu-4">
                      <div class="py-1" role="none">
                        <button type="button" class="flex justify-between w-full px-4 py-2 text-sm text-gray-700 hover:bg-gray-100 hover:text-gray-900" role="menuitem">
          ...
          <div class="relative flex flex-col h-full bg-gray-100 border-r border-gray-200 w-96">
            ...
            <nav aria-label="Message list" class="flex-1 min-h-0 overflow-y-auto">
              <ul class="border-b border-gray-200 divide-y divide-gray-200">
                <li class="relative px-6 py-5 bg-white hover:bg-gray-50 focus-within:ring-2 focus-within:ring-inset focus-within:ring-blue-600">
