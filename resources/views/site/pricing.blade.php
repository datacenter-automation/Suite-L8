...
<div class="bg-white">
    ...
    <div class="px-4 mx-auto max-w-7xl sm:px-6">
      <div class="flex items-center justify-between py-6 border-b border-gray-200 md:justify-start md:space-x-10">
        ...
        <div class="-my-2 -mr-2 md:hidden">
          <button type="button"
                  class="inline-flex items-center justify-center p-2 text-gray-400 bg-white rounded-md hover:text-gray-500 hover:bg-gray-100 focus:outline-none focus:ring-2 focus:ring-inset focus:ring-purple-500"
                  aria-expanded="false">
        ...
        <nav class="hidden space-x-10 md:flex">
          <div class="relative">
            ...
            <button type="button"
                    class="inline-flex items-center text-base font-medium text-gray-500 bg-white rounded-md group hover:text-gray-900 focus:outline-none focus:ring-2 focus:ring-offset-2 focus:ring-purple-500"
                    aria-expanded="false">
              <span>Solutions</span>
              <!--
        ...
        <div class="items-center justify-end hidden space-x-8 md:flex md:flex-1 lg:w-0">
          ...
          <a href="#"
             class="inline-flex items-center justify-center px-4 py-2 text-base font-medium text-purple-600 bg-purple-100 border border-transparent rounded-md whitespace-nowrap hover:bg-purple-200">
            Sign up
          </a>
        </div>
      </div>
      ...
      <div class="bg-white divide-y-2 rounded-lg shadow-lg ring-1 ring-black ring-opacity-5 divide-gray-50">
        <div class="px-5 pt-5 pb-6 space-y-6">
          <div class="flex items-center justify-between">
            <div>
              <img class="w-auto h-8" src="https://tailwindui.com/img/logos/workflow-mark-purple-600.svg"
                   alt="Workflow">
            </div>
            <div class="-mr-2">
              <button type="button"
          ...
          <div class="mt-6">
            <nav class="grid gap-y-8">
              <a href="#" class="flex items-center p-3 -m-3 rounded-md hover:bg-gray-50">
                <!-- Heroicon name: outline/chart-bar -->
                <svg class="flex-shrink-0 w-6 h-6 text-purple-600" xmlns="http://www.w3.org/2000/svg" fill="none"
        ...
        <div class="px-5 py-6 space-y-6">
          ...
          <div class="space-y-6">
            <a href="#"
               class="flex items-center justify-center w-full px-4 py-2 text-base font-medium text-white bg-purple-600 border border-transparent rounded-md hover:bg-purple-700">
              Sign up
            </a>
    ...
    <div class="px-4 pt-24 mx-auto max-w-7xl sm:px-6 lg:px-8">
      <div class="sm:flex sm:flex-col sm:align-center">
        ...
        <div class="relative mt-6 bg-gray-100 rounded-lg p-0.5 flex self-center sm:mt-8">
          <button type="button"
                  class="relative w-1/2 py-2 text-sm font-medium text-gray-700 bg-white border-gray-200 rounded-md shadow-sm whitespace-nowrap focus:outline-none focus:ring-2 focus:ring-purple-500 focus:z-10 sm:w-auto sm:px-8">
            Monthly billing
          </button>
          <button type="button"
      ...
      <div
        ...
        <div class="border border-gray-200 divide-y divide-gray-200 rounded-lg shadow-sm">
          <div class="p-6">
            ...
            <a href="#"
               class="block w-full py-2 mt-8 text-sm font-semibold text-center text-white bg-purple-600 border border-transparent rounded-md hover:bg-purple-700">Buy
              Hobby</a>
          </div>
    ...
    <div class="lg:grid lg:grid-cols-3 lg:gap-8">
      <div class="space-y-4">
        ...
        <p class="text-lg text-gray-500">Can’t find the answer you’re looking for? Reach out to our <a href="#"
                                                                                                       class="font-medium text-purple-600 hover:text-purple-500">customer
            support</a> team.</p>
      </div>
  ...
  <footer class="bg-gray-900">
    <div class="px-4 py-12 mx-auto max-w-7xl sm:px-6 lg:py-16 lg:px-8">
            ...
            <fieldset class="w-full">
              ...
              <div class="relative">
                <select id="language" name="language"
                        class="block w-full text-base text-white bg-gray-800 border border-transparent rounded-md bg-none focus:ring-white focus:border-white sm:text-sm">
      ...
      <div
        class="pt-8 space-y-4 border-t border-gray-700 lg:space-y-0 lg:flex lg:items-center lg:justify-between xl:mt-0">
        <div class="space-y-2">
          <h3 class="text-sm font-semibold tracking-wider text-gray-400 uppercase">
        ...
        <form class="sm:flex sm:max-w-md">
          ...
          <input type="email" name="emailAddress" id="emailAddress" autocomplete="email" required
                 class="w-full min-w-0 px-4 py-2 placeholder-gray-500 bg-white border border-transparent rounded-md focus:ring-2 focus:ring-offset-2 focus:ring-offset-gray-800 focus:ring-white focus:border-white sm:max-w-xs"
                 placeholder="Enter your email">
          <div class="mt-3 rounded-md sm:mt-0 sm:ml-3 sm:flex-shrink-0">
            <button type="submit"
                    class="flex items-center justify-center w-full px-4 py-2 text-base font-medium text-white bg-purple-600 border border-transparent rounded-md hover:bg-purple-700 focus:outline-none focus:ring-2 focus:ring-offset-2 focus:ring-offset-gray-800 focus:ring-purple-500">
              Subscribe
            </button>
          </div>
        </form>
